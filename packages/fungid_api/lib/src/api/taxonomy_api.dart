...
class TaxonomyApi {
  ...
  Future<Response<PageSpecies>> getAllSpeciesTaxonomySpeciesGet({
    ...
    final _path = r'/taxonomy/species/';
    ...
    PageSpecies _responseData;

    try {
      const _responseType = FullType(PageSpecies);
  ...
  Future<Response<Species>> getSpeciesTaxonomySpeciesNameOrIdGet({
    ...
    Species _responseData;

    try {
      const _responseType = FullType(Species);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as Species;
