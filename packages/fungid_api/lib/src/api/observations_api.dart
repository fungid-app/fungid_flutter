...
class ObservationsApi {
  ...
  Future<Response<PageGbifObservation>> getAllObservationsObservationsGet({ 
    ...
    PageGbifObservation _responseData;

    try {
      const _responseType = FullType(PageGbifObservation);
  ...
  Future<Response<GbifObservationImage>> getImageByIdObservationsImagesImageIdGet({ 
    ...
    GbifObservationImage _responseData;

    try {
      const _responseType = FullType(GbifObservationImage);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  Future<Response<PageGbifObservationImage>> getObservationImagesByObservationIdObservationsObservationIdImagesGet({ 
    ...
    PageGbifObservationImage _responseData;

    try {
      const _responseType = FullType(PageGbifObservationImage);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  Future<Response<PageGbifObservationImage>> getObservationImagesObservationsImagesGet({ 
    ...
    final _path = r'/observations/images';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<GbifObservation>> getObservationsByIdObservationsIdGet({ 
    ...
    GbifObservation _responseData;

    try {
      const _responseType = FullType(GbifObservation);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as GbifObservation;
