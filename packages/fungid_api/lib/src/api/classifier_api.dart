...
class ClassifierApi {
  ...
  Future<Response<BuiltMap<String, num>>>
    ...
    final _path = r'/classifier/image';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltMap<String, num>>>
    ...
    final _path = r'/classifier/location';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltMap<String, num>>>
    ...
    final _path = r'/classifier/tabular';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<String>>> getLocalClassifierLocalGet({
    ...
    final _path = r'/classifier/local';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PageBasicPrediction>> getSeasonalClassifierSeasonalGet({
    ...
    final _path = r'/classifier/seasonal';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PageBasicPrediction _responseData;

    try {
      const _responseType = FullType(PageBasicPrediction);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  Future<Response<ClassifierVersion>> getVersionClassifierVersionGet({
    ...
    final _path = r'/classifier/version';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ClassifierVersion _responseData;

    try {
      const _responseType = FullType(ClassifierVersion);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
